...
const Slider: React.FC<SliderProps> = ({ title, seeMore, centered, children }) => {
  return (
    <div>
      ...
      {centered ? (
        <div className="overflow-x-auto scrollbar-hide snap-x snap-mandatory scroll-smooth touch-pan-x flex">
          {children}
        </div>
      ) : (
